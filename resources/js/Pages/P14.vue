  ...
  <container>
    ...
    <div class="corpo">
      ...
      <div class="todo">
        ...
        <div class="resposta">
          <button type="button" name="p1" id="p1" @click="store" class="botao">NÃO TENHO CERTEZA</button><br><br>
          <button type="button" name="p2" id="p2" @click="store" class="botao"> SIM, ESTÁ TUDO SOB
            CONTROLE</button><br><br>
          <button type="button" name="p2" id="p2" @click="store" class="botao"> AUMENTEI OS NÍVEIS DE AÇÚCAR
            OCASIONALMENTE</button><br><br>
          <button type="button" name="p2" id="p2" @click="store" class="botao">NÃO, TENHO DIABETES</button><br><br>
        </div>
      </div>
    </div>
