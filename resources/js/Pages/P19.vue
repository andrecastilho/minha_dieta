...
<template>
  <container>
    ...
    <div class="corpo">
      ...
      <div class="todo">
        <div class="resposta">
          <button type="button" name="p1" id="p1" @click="store" class="botao">SIM, MUITO</button><br><br>
          <button type="button" name="p1" id="p1" @click="store" class="botao">MUITO AS VEZES</button><br><br>
          <button type="button" name="p1" id="p1" @click="store" class="botao">RARAMENTE</button><br><br>
