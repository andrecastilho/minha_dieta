...
<template>
  <container>
    ...
    <div class="corpo">
      ...
      <div class="todo">
        <div class="resposta">
          <button type="button" name="p1" id="p1" @click="store" class="botao">QUASE NÃO PRATICO ATIVIDADE
            FÍSICA</button><br><br>
        </div>
        <div class="resposta">
          <button type="button" name="p2" id="p2" @click="store" class="botao ">EU CAMINHO AS VEZES</button><br><br>
        </div>
        <div class="resposta">
          <button type="button" name="p3" id="p3" @click="store" class="botao ">EU ME EXERCITO DE 1 A 2 VEZES POR
            SEMANA</button><br><br>
        </div>
        <div class="resposta">
          <button type="button" name="p4" id="p4" @click="store" class="botao ">EU ME EXERCITO DE 3 A 5 VEZES POR
            SEMANA</button><br><br>
        </div>
        <div class="resposta">
          <button type="button" name="p5" id="p5" @click="store" class="botao ">EU ME EXERCITO DE 5 A 7 VEZES POR
            SEMANA</button><br><br>
        </div>
      </div>
    </div>
