...
<template>
  <container>
    ...
    <div class="corpo">
      ...
      <div class="todo">
        <div class="resposta">
          <button type="button" name="p1" id="p1" @click="store" class="botao"> ÀS VEZES</button><br><br>
          <button type="button" name="p2" id="p2" @click="store" class="botao"> NUNCA</button><br><br>
          <button type="button" name="p2" id="p2" @click="store" class="botao"> FREQUENTIMENTE</button><br><br>
          <button type="button" name="p2" id="p2" @click="store" class="botao">QUASE SEMPRE</button><br><br>
        </div>
      </div>
    </div>
